...
_G.packer_plugins = {
  ale = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/home/alex/.local/share/nvim/site/pack/packer/opt/ale",
    url = "https://github.com/w0rp/ale"
  },
  black = {
    loaded = true,
    path = "/home/alex/.local/share/nvim/site/pack/packer/start/black",
  ...
  ["lightline-gruvbox.vim"] = {
    loaded = true,
    path = "/home/alex/.local/share/nvim/site/pack/packer/start/lightline-gruvbox.vim",
